...
public class ListPaymodeActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {

    ListView listViewPaymode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_paymode);

        listViewPaymode = (ListView) findViewById(R.id.listViewPaymode);
        listViewPaymode.setOnItemClickListener(this);
    ...
    public void refresh() {
        ...
        String query = "Select * from " + ExpenseClass.TABLE_EXPENSE + " where " + ExpenseClass.COL_EXPENSE_USER_ID + " = " + userId + " order by " + ExpenseClass.COL_EXPENSE_PAYMENT_MODE + ";";
        ...
        if (!cursor.isAfterLast()) {
            ...
            while (!cursor.isAfterLast()) {
                ...
                listViewPaymode.setAdapter(expenseAdapter);
