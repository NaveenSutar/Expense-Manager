...
public class ListExpandableActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void refresh() {
        ...
        String query = "Select * from " + ExpenseClass.TABLE_EXPENSE + " where " + ExpenseClass.COL_EXPENSE_USER_ID + " = " + userId + " order by " + ExpenseClass.COL_EXPENSE_NAME + " ; ";
